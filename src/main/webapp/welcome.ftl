...
<!--Start of Zopim Live Chat Script-->
	...
	$.src='//cdn.zopim.com/?tthuqXHJUuR3jEOYRiW9h8zugxnoWriM';z.t=+new Date;$.
				...
				<div class="navbar-inner">
					...
					<div class="nav-collapse collapse">
						...
						<ul class="nav pull-right">
                      		<li><a href="login.ftl"><b>LOGIN</b></a></li>
                    	</ul>
					</div>
					<!--/.nav-collapse -->
				</div>
	...
	<script type="text/javascript">
		...
		jQuery('button.submit').on('click', function() {
			...
			if(companyName == '' || companyName.length < 5){
				bootbox.alert('Company name should not be blank and should contrain minimum 5 letters');
				return;
			}else if(companyId == '' || companyId.length < 5){
				bootbox.alert('Company Id should not be blank and should contrain minimum 5 letters');
				return;
			}else if(userName == '' || userName.length < 5){
				bootbox.alert('User name should not be blank and should contrain minimum 5 letters');
				return;
			}else if(password == '' || password.length < 5){
				bootbox.alert('Password should not be blank and should contrain minimum 5 letters');
				return;
			}else{
					jQuery.ajax({
						url : '/signup.html',
