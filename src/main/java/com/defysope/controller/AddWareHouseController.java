...
public class AddWareHouseController {
	...
	public @ResponseBody
	Object addWarehouse(HttpServletRequest request, @ModelAttribute("whouse") Warehouse whouse) {
		Warehouse savedWarehouse = warehouseSettingsManager.saveWarehouse(whouse);
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("savedWarehouse", savedWarehouse);
		return model;
